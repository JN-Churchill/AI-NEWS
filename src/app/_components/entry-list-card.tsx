  ...
  return (
    <article className="rounded-md border border-neutral-200 bg-white p-5 shadow-sm transition hover:border-neutral-400">
      <div className="flex flex-wrap items-center gap-2 text-xs font-semibold text-neutral-500">
        <Link href={`/daily/${item.issueDate}`} className="rounded bg-neutral-100 px-2 py-1 text-neutral-700 hover:bg-neutral-200">
          {item.issueDate}
        </Link>
      ...
      <h2 className="mt-3 text-xl font-semibold leading-8 text-neutral-950">{item.title}</h2>
