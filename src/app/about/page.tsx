    ...
    <main>
      <section className="border-b border-neutral-900 bg-neutral-950 text-white">
        <Container className="grid gap-6 py-8 lg:grid-cols-[1fr_360px]">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.22em] text-emerald-300">Method</p>
            <h1 className="mt-4 text-4xl font-semibold leading-tight">评分方法</h1>
          ...
          <div className="border-t border-white/10 pt-5 lg:border-l lg:border-t-0 lg:pl-6 lg:pt-0">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-neutral-400">Publishing Guardrails</p>
